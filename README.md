...
git clone https://github.com/YOUR\\girish-m-vyas/iamgpt-agent.git
cd iamgpt-agent
...
* **Laptop** → http://localhost:3000
* **Mobile** → http://YOUR\_LOCAL\_IP:3000 *(shown in terminal, same Wi-Fi)*
...
```env
GROQ\\\_API\\\_KEY=gsk\\\_XXXXXXXXXXXXXXXXXXXXXXXX
```
...
├── .gitignore         # Excludes .env and node\\\_modules
└── public/
...
5. Add Environment Variable: `GROQ\\\_API\\\_KEY` = your key
...
[!\[LinkedIn](https://img.shields.io/badge/LinkedIn-Connect-0077B5?style=flat&logo=linkedin)](https://www.linkedin.com/in/girish-m-vyas/)
[!\[Email](https://img.shields.io/badge/Email-gmvyas208%2540gmail.com-D14836?style=flat&logo=gmail)](mailto:gmvyas208@gmail.com)
